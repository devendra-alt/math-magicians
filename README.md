...
**MATH Magicians** is a simple react Single page application where user can perform simple math calculation and also see random math quotes daily
...
```sh
  cd my-folder
  git clone https://github.com/devendra-alt/math-magicians
```
